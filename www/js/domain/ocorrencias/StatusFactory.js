...
define(function () {
    ...
    var Position = require('ocorrencias/Pendent');
    var Position = require('ocorrencias/Resolved');
    var Position = require('ocorrencias/Excluded');
    var Position = require('ocorrencias/Reopenned');
